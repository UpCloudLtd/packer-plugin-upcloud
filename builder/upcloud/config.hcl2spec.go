...
// FlatMapstructure returns a new FlatIPAddress.
// FlatIPAddress is an auto-generated flat version of IPAddress.
// Where the contents a fields with a `mapstructure:,squash` tag are bubbled up.
func (*IPAddress) FlatMapstructure() interface{ HCL2Spec() map[string]hcldec.Spec } {
	return new(FlatIPAddress)
}

// HCL2Spec returns the hcl spec of a IPAddress.
// This spec is used by HCL to read the fields of IPAddress.
